...
func _benchmarkModAddNat(m *Nat, b *testing.B) {
	var x Nat
	x.SetBytes(ones())
	for n := 0; n < b.N; n++ {
		var z Nat
...
func _benchmarkModMulNat(m *Nat, b *testing.B) {
	var x Nat
	x.SetBytes(ones())
	for n := 0; n < b.N; n++ {
		var z Nat
...
func _benchmarkModInverseNat(m *Nat, b *testing.B) {
	var x Nat
	x.SetBytes(ones())
	for n := 0; n < b.N; n++ {
		var z Nat
...
func _benchmarkExpNat(m *Nat, b *testing.B) {
	var x Nat
	x.SetBytes(ones())
	for n := 0; n < b.N; n++ {
		var z Nat
